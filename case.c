...
void casedouane( int de[3], t_joueur tabdejoueur[6], int i, int nb_joueur)
{
    ...
    switch(choix)
    {
        ...
        case 2:
            {
                if (tabdejoueur[i].possession[33]!=0)
                {
